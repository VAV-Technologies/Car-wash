  ...
  return (
    <>
      ...
      <section className="w-full relative text-brand-white section-lines-light">
        ...
        <div className="container mx-auto flex flex-col items-center justify-center text-center min-h-[calc(100vh-120px)] px-4 py-24 md:py-32 lg:py-40 relative z-10">
