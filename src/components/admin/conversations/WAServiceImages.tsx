...
const SERVICES = [
  ...
  { key: 'sub_essentials', label: 'Subscription Essentials', price: 'Hemat Rp 1.057.000/bulan' },
  { key: 'sub_plus', label: 'Subscription Plus', price: 'Hemat Rp 2.147.000/bulan' },
  { key: 'sub_elite', label: 'Subscription Elite', price: 'Hemat Rp 3.494.000/bulan' },
]
