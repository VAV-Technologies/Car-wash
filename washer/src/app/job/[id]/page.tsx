...
import { getJobById, updateJobRecord, updateBookingStatus } from '@/lib/jobs'
import { getSOPChecklist, uploadJobPhoto, getJobPhotos } from '@/lib/sop'
import { SERVICE_TYPES } from '@/lib/constants'
import SOPChecklist, { type SOPStep } from '@/components/SOPChecklist'
import {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="text-center space-y-3">
          ...
          <button onClick={() => router.push('/today')} className="text-orange-400 underline text-sm">
            Back to Today
          </button>
        </div>
      </div>
